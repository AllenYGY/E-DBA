...
class VerificationStatus(Base):
    ...
    e_admin_approved = Column(Enum(VerificationStatusEnum), default=VerificationStatusEnum.PENDING)  # E-Admin初审结果
    senior_approved = Column(Enum(VerificationStatusEnum), default=VerificationStatusEnum.PENDING)  # Senior E-Admin终审结果
